...
class GuessingGame(gym.Env):
    ...
    The episode_to_enemy terminates after the agent guesses within 1% of the target or
    ...
    each episode_to_enemy a state-value or action-value function isn't able to provide any additional
